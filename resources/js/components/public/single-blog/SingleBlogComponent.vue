        ...
        <div class="row">
          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry entry-single">
              ...
              <div class="entry-img">
                <img :src="`${singleBlog.image}`" alt="" class="img-fluid">
              </div>

              <h2 class="entry-title">
                <a href="blog-single.html">{{singleBlog.title}}</a>
              </h2>
              ...
              <div class="entry-content">
                <p>
                    {{singleBlog.short_desc}}
                </p>

                <!-- <div>
                    {{singleBlog.long_desc}}
                </div> -->
                <span v-html="singleBlog.long_desc"></span>
              ...
              <div class="entry-footer clearfix">
                <div class="float-left">
                  ...
                  <ul class="cats">
                    <li><a href="#">{{singleBlog.category.cat_name}}</a></li>
                  </ul>

                  <i class="icofont-tags"></i>
                  <ul class="tags">
                    <li v-for="tag in singleBlog.blog_tag"><a href="#">{{tag.tag.tag_name}}</a></li>
                  </ul>
                </div>
            ...
            <div class="blog-author clearfix">
              <img :src="`${singleBlog.author.image}`" class="rounded-circle float-left" alt="">
              <h4>{{singleBlog.author.auth_name}}</h4>
